...
int main()
{
    ...
    r.date = 201012;
    r.time = 201510;
    convDateTime(r);//Eseguo un semplice test per controllare che la funzione convDateTime effettui la conversione.
    std::cout << "Stampo i giorni : " << r.gg << " I mesi : " << r.mm <<" L'anno : " << r.aaaa << std::endl;
    std::cout << "Stampo le ore : " << r.h << " I minuti : " << r.m <<" I secondi : " << r.s << std::endl;
